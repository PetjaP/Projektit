  ...
  else
{
  ...
  if(arvaus < arvattava)
{
  m1.innerHTML = "Arvauksesi on liian pieni";
}
  else if(arvaus > arvattava)
{
  m1.innerHTML = "Arvauksesi on liian suuri";
}
  else {
  m1.innerHTML = "Oikein!";
}
...
//Määritellään nappien käyttäytyminen
function napit(arvo)
{
if(arvaustenLukumaara >= 3)
{
